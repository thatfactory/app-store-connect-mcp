...
export function registerCapabilities(server: McpServer, config: Configuration): void {
  server.registerTool('get_capabilities', {
    ...
    const result = {schemaVersion: 1, stage: 'discovery', tools: ['get_capabilities', 'validate_repository', 'list_apps', 'get_app_store_state', 'export_app_store_state', 'prepare_app_record'], remoteWritesImplemented: false,
